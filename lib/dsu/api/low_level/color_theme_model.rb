    ...
    module LowLevel
      ...
      class ColorThemeModel < JsonFile
        ...
        class << self
          ...
          def current
            theme_name = configuration_model.theme_name
          ...
          def find(theme_name:)
            ...
            Services::ColorThemeModel::HydratorService.new(theme_name: theme_name, theme_hash: theme_hash).call
          end
          ...
          #   theme_hash = Models::ColorThemeModel.send(:replace, color_theme_model: default,
          ...
          def replace(color_theme_model:, replace_color:, with_color:)
            colors_theme_hash = color_theme_model.to_theme_colors_h.tap do |hash|
          ...
          # theme_name in the configuration_model is the same as the deleted theme,
          # we need to reset the configuration_model theme to the default theme.
          ...
          def themes_path_for(theme_name:)
            Modules::Fileable.themes_path(theme_name: theme_name)
          end
        end
