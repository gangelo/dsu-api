      ...
      module Modules
        module TimesSortable
          def sorted_dsu_times_for(times:)
            configuration_model = Models::ConfigurationModel.new unless defined?(configuration_model) && configuration_model
            entries_display_order = configuration_model.entries_display_order
