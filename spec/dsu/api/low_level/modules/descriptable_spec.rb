...
RSpec.describe Dsu::Api::LowLevel::Modules::Descriptable, type: :module do
  subject(:descriptable) do
    Class.new do
      include Dsu::Api::LowLevel::Modules::Descriptable
...
def description_having(max_length: Dsu::Api::LowLevel::Modules::Descriptable::DESCRIPTION_MAX_COUNT)
  num_words = Dsu::Api::LowLevel::Modules::Descriptable::DESCRIPTION_MAX_COUNT
