...
RSpec.describe Dsu::Api::LowLevel::MigrationVersionModel do
  ...
  describe '#current_migration?' do
    ...
    context 'when the migration version less than the current version' do
      subject(:migration_version) { build(:migration_version, version: 1 - Dsu::Api::LowLevel::Migration::VERSION) }
