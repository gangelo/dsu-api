...
RSpec.describe Dsu::Api::LowLevel::ColorThemeModel do
  ...
  shared_examples 'the color theme exists' do
    it 'the color theme file exists' do
      theme_path = Dsu::Api::LowLevel::Modules::Fileable.themes_path(theme_name: theme_name)
  ...
  describe 'validations' do
    it 'validates #description with DescriptionValidator' do
      expect(color_theme).to validate_with_validator(Dsu::Api::LowLevel::Validators::DescriptionValidator)
    end

    it 'validates the color theme color attributes with the ColorThemeValidator' do
      expect(color_theme).to validate_with_validator(Dsu::Api::LowLevel::Validators::ColorThemeValidator)
    end

    it 'validates #version attribute with the VersionValidator' do
      expect(color_theme).to validate_with_validator(Dsu::Api::LowLevel::Validators::VersionValidator)
    end
  end
